...
/*
//No funciona debido a que no existe el backend, pero se deja como referencia de la estructura del componente y su conexión con el store de Redux.
...
const ProductPage = () => {
  ...
  const { product, stock, loading, error } = useSelector(
  ...
  if (loading) return <div style={styles.center}>Cargando producto...</div>;
